    ...
    func createCustomNavigationBar (view: UIView, leftBarButtonIcon: String?, leftBarButtonSelectedIcon: String?, leftBarButton: UIButton?, rightBarButtonIcon: String?, rightBarButtonSelectedIcon: String?, rightBarButton: UIButton?, title: String?){
        ...
        if leftBarButtonIcon != nil {
            ...
            if leftBarButtonIcon == "Right_Arrow" || leftBarButtonIcon == "Left_Arrow" {
                leftBarButton?.frame = CGRect(x: 0.02525*DisplayUtility.screenWidth, y: 0.05*DisplayUtility.screenHeight, width: 0.0532*DisplayUtility.screenWidth, height: 0.02181*DisplayUtility.screenHeight)
            } else {
        ...
        if rightBarButtonIcon != nil && rightBarButton != nil {
            ...
            if rightBarButtonIcon == "Right_Arrow" || rightBarButtonIcon == "Left_Arrow" {
                rightBarButton?.frame = CGRect(x: 0.87705*DisplayUtility.screenWidth, y: 0.05*DisplayUtility.screenHeight, width: 0.0532*DisplayUtility.screenWidth, height: 0.02181*DisplayUtility.screenHeight)
            } else if rightBarButtonIcon == "Leave_Conversation_Gray"{
                rightBarButton?.frame = CGRect(x: 0.87705*DisplayUtility.screenWidth, y: 0.04633*DisplayUtility.screenHeight, width: 0.0532*DisplayUtility.screenWidth, height: 0.0532*DisplayUtility.screenWidth)
            } else {
                rightBarButton?.frame = CGRect(x: 0.87705*DisplayUtility.screenWidth, y: 0.04633*DisplayUtility.screenHeight, width: 0.1*DisplayUtility.screenWidth, height: 0.1*DisplayUtility.screenWidth)
            }
