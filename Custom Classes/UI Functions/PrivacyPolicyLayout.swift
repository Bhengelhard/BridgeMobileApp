...
class PrivacyPolicyLayout {
    ...
    func initialize(view: UIView, didSetupConstraints: Bool) -> Bool {
        ...
        if (!didSetupConstraints) {
            ...
            fbLoginButton.autoPinEdge(.top, to: .bottom, of: returnToLoginButton, withOffset: buffer)
            ...
            privacyHeaderLabel.autoPinEdge(.top, to: .bottom, of: fbLoginButton, withOffset: buffer + 15)
            ...
            neverPostLabel.autoPinEdge(.top, to: .bottom, of: privacyHeaderLabel, withOffset: buffer)
            ...
            introducedByLabel.autoPinEdge(.top, to: .bottom, of: neverPostLabel, withOffset: buffer)
            ...
            introductionControlLabel.autoPinEdge(.top, to: .bottom, of: introducedByLabel, withOffset: buffer)
            ...
            introducedByControlLabel.autoPinEdge(.top, to: .bottom, of: introductionControlLabel, withOffset: buffer)
            ...
            privacyPolicyButton.autoPinEdge(.top, to: .bottom, of: introducedByControlLabel, withOffset: buffer)
