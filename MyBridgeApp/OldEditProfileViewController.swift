...
class OldEditProfileViewController: UIViewController, UITextViewDelegate, UIGestureRecognizerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    var myProfileVC: OldMyProfileViewController
    ...
    init(myProfileVC: OldMyProfileViewController) {
    ...
    func setQuickUpdateText() {
        ...
        User.getCurrent { (user) in
            if let quickUpdate = user.quickUpdate {
                ...
                self.quickUpdatePlaceholder = false
            } else {
